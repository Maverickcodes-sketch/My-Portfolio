  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          // Contain the image within the plane so it's fully visible.
          vec2 ratio = vec2(
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/spring/spring-original.svg', text: 'Spring Boot' },
      { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original.svg', text: 'Docker' },
      { image: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/redis/redis-original.svg', text: 'Redis' },
    ];
  ...
  addEventListeners() {
    ...
    this.boundOnWheelCapture = e => this.boundOnWheel(e);
    this.boundOnTouchDown = this.onTouchDown.bind(this);
    this.boundOnTouchMove = this.onTouchMove.bind(this);
    this.boundOnTouchUp = this.onTouchUp.bind(this);
    window.addEventListener('resize', this.boundOnResize);
    if (this.container) {
      this.container.addEventListener('mousewheel', this.boundOnWheelCapture, { passive: false });
      this.container.addEventListener('wheel', this.boundOnWheelCapture, { passive: false });
  ...
  destroy() {
    ...
    if (this.container) {
      this.container.removeEventListener('mousewheel', this.boundOnWheelCapture);
      this.container.removeEventListener('wheel', this.boundOnWheelCapture);
